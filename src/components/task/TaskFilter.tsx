...
export const TaskFilter = () => {
  ...
  return (
    <section className="rounded-3xl border border-slate-200/80 bg-white/95 p-4 shadow-lg backdrop-blur dark:border-slate-700/80 dark:bg-slate-900/95">
      <div className="mb-3 flex items-center justify-between border-b border-slate-200/80 pb-2 dark:border-slate-700/70">
      ...
      <div className="grid gap-3 sm:grid-cols-3">
        ...
        <select
          ...
          className="select-clean rounded-xl border border-slate-300/90 bg-white px-3.5 py-2.5 text-sm shadow-sm outline-none ring-sky-500 transition focus:border-sky-400 focus:ring-2 dark:border-slate-700 dark:bg-slate-950"
        >
          <option>All</option>
